 ...
 * Description:
 */
public class BottomSheetRadiusDialog {
    ...
    public BottomSheetRadiusDialog(Context context) {
    ...
    public BottomSheetRadiusDialog init() {
        // 获取Dialog布局
        View view = LayoutInflater.from(mContext).inflate(R.layout.view_actionsheet_radius, null);
    ...
    public BottomSheetRadiusDialog setTitle(String title) {
        showTitle = true;
    ...
    public BottomSheetRadiusDialog setCancelable(boolean cancel) {
        dialog.setCancelable(cancel);
        return this;
    }


    public BottomSheetRadiusDialog setDefaultItemStyle(SheetItemTextStyle textStyle) {
        this.defaultItemStyle = textStyle;
        return this;
    }

    public BottomSheetRadiusDialog setBottomBtnStyle(SheetItemTextStyle textStyle) {
        this.defaultBottomBtnStyle = textStyle;
        return this;
    }

    public BottomSheetRadiusDialog setCanceledOnTouchOutside(boolean cancel) {
        dialog.setCanceledOnTouchOutside(cancel);
        return this;
    }


    public BottomSheetRadiusDialog addSheetItem(SheetItem sheetItem) {
        addSheetItem2List(sheetItem);
        return this;
    }

    public BottomSheetRadiusDialog addSheetItem(String strItem, SheetItemTextStyle textStyle,
                                                OnSheetItemClickListener listener) {
        addSheetItem2List(new SheetItem(strItem, textStyle, listener));
        return this;
    }

    public BottomSheetRadiusDialog addSheetItem(String strItem, OnSheetItemClickListener listener) {
        addSheetItem2List(
                new SheetItem(
                        strItem,
