...
public class WheelSurfView extends RelativeLayout {
    ...
    public void setConfig(Builder builder) {
        ...
        if ( builder.mTypeModel != 0 )
            mWheelSurfPanView.setmTypeModel(builder.mTypeModel);
        ...
        if ( builder.mGoImgRes != 0 )
            mStart.setImageResource(builder.mGoImgRes);
        mWheelSurfPanView.show();
    }

    public ImageView getGoBtn(){
        return mStart;
    }
    ...
    public static final class Builder {
        ...
        public final WheelSurfView.Builder setmTypeModel(int mTypeModel) {
